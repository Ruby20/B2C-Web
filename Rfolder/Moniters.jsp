  ...
  <div id="div" align="">
    <form id="order" action="Update.jsp" method="post" onsubmit="return isEmpty()">
      <table width="100%" border="1" align="center" background="../images/back.jpg">
        <tr>
          <td colspan="8"><div align="center" class="style64 style65">Moniters</div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
            <td><div align="center" class="style67"><a href="../ROrders.jsp" class="style69">Buy Now</a></div></td>
          <td><div align="center"><a href="Products.jsp" class="style68">Back</a></div></td>
        </tr>
      </table>
