...
.style59 {font-size: 18px; color: #FF6600; }
.style60 {color: green}
-->
</style>
</head>
...
<div id="logo">
	<h1><span class="style57">B</span> <span class="style60">2</span> <span class="style57">c network solutions </span></h1>
</div>
<div id="menu">
  <p>&nbsp;</p>
  <table width="100%" border="0">
    <tr>
      ...
      <td width="35%"><span class="style59">Retailers Blog</span></td>
    </tr>
  </table>
...
<table width="73%" height="782" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr >
	...
	<td background="images/top1bg.gif"><div align="center"><a href="Ret.jsp" class="style10">Home</a></div></td>
