...
.style30 {color: red; font-size: 18px; }
-->
</style>
</head>
...
<div id="menu">
  ...
  <tr>
    <td width="24%" class="style62 style25 style29">Welcome</td>
    <td width="41%"><span class="style30" >
      <%if(usrname==null){}else{%>
      <%=usrname%>
      <%}%>
    </span></td>
    <td width="35%"><span class="style62 style29 style25">Manufacturers Blog</span></td>
  </tr>
</table>
</p>
...
<table width="73%" height="775" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr >
    <td height="31" background="images/top1bg.gif">&nbsp;</td>
	<td background="images/top1bg.gif"><div align="center"><a href="Man.jsp" class="style10">Home</a></div></td>
  ...
  <tr>
    ...
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input name="t15" type="text" disabled="disabled" id="t15" value="Manufacturer" size="15" maxlength="25" />
