...
<div id="page">
<form name="order" id="order" action="Product.do" method="post" onSubmit="return isEmpty()">
<table width="73%" height="601" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr >
  ...
  <tr>
    ...
    Your Product Detailes </strong></td>
  </tr>
  <tr>
    <td height="16">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>Company Name </td>
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input name="t2" type="text" id="t2" size="55" maxlength="30" />
    </font></b></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Market Price </td>
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input name="t3" type="text" id="t3" size="55" maxlength="30" />
    </font></b></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Quantity</td>
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input name="t4" type="text" id="t4" size="55" maxlength="30"  />
    </font></b></td>
  </tr>
  <tr>
    <td height="44">&nbsp;</td>
    <td>Model Name  </td>
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input name="t5" type="text" id="t5" size="55" maxlength="30" />
    </font></b></td>
  </tr>
  
  <tr>
    <td>&nbsp;</td>
    <td colspan="2"><strong>Enter Product Configeration </strong></td>
  </tr>
  <tr>
    <td height="202">&nbsp;</td>
    <td>Features of Product </td>
