...
.style31 {color: red; font-size: 18px; }
...
<div id="menu">
  ...
  <table width="100%" border="0">
    <tr>
      <td width="24%"><span class="style49 style25 style29">Welcome</span></td>
      <td width="41%"><span class="style31" >
        <%if(usrname==null){}else{%>
        <%=usrname%>
        <%}%>
      </span></td>
      <td width="35%"><span class="style49 style25 style29">Customers Blog</span></td>
    </tr>
  </table>
...
<table width="73%" height="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr >
    <td height="26" background="images/top1bg.gif">&nbsp;</td>
	<td background="images/top1bg.gif"><div align="center"><a href="Main.jsp" class="style10">Home</a></div></td>
  ...
  <tr>
    ...
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input name="t15" type="text" disabled="disabled" id="t15" value="Customer" size="15" maxlength="25" />
