...
<div id="page">
  ...
  <div id="div" align="">
    <form id="order" action="Update.jsp" method="post" onsubmit="return isEmpty()">
      <table width="73%" height="54" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr >
          ...
          <td width="21%" background="../images/top1bg.gif"><div align="center"><a href="../Man.jsp" class="style25">Home</a></div></td>
          <td width="77%" background="../images/top1bg.gif"><div align="right"> Date:
        ...
        <tr>
          <td colspan="10"><table align="center" border="3" cellspacing="1">
              <caption>
              <h1 class="style63" >Manufacturers Report</h1>
              </caption>
            <tr>
   ...
   ResultSet rs=st.executeQuery("select * from register where t1='m'  ");
   while(rs.next())
   {
    out.println("<tr><td>");
