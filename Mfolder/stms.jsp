...
<table width="100%" height="627" border="0" cellpadding="0" cellspacing="0" background="../images/KINGW013.JPG">
    	...
    	<td height="403" colspan="3" valign="top"><table width="100%" height="440" border="0" align="center" cellpadding="0" cellspacing="0"  >
          ...
          <tr>
            ...
            <td width="880" class="bordertop" ><table width="786" height="167" border="1" align="center">
              <tr>
                <td  height="31" colspan="5"><div align="center" class="style39">Manufactureres Sitemap</div></td>
              </tr>
              <tr>
                <td width="167" height="25"><div align="center" class="style38"><a href="../login.jsp" class="style41">Login Page</a> </div></td>
                <td width="176"><div align="center" class="style38"><a href="../Man.jsp" class="style41">Manufactureres Blog</a></div></td>
                <td width="184"><div align="center" class="style38">Categaries</div></td>
                <td width="215"><div align="center"><span class="style38">Reports</span></div></td>
              </tr>
              <tr>
                <td height="101"><ul>
                  ...
                  <p>&nbsp;</p></td>
                <td><ul class="style28">
                    <li><a href="../Man.jsp" class="style42">Home</a></li>
                </ul>
                    <ul class="style28">
                ...
                <td><ul class="style40">
                    <li><a href="../MProfile.jsp" class="style42">Your Prifile</a></li>
                </ul>
                    <ul class="style40">
                  ...
                  <ul class="style40">
                      <li><a href="../Add New Product.jsp" class="style42">Add New Products</a></li>
                  </ul>
                  <ul class="style40">
                      <li><a href="../MFeedback.jsp" class="style42">Feedback </a></li>
                  </ul></td>
                <td><ul class="style28">
                    <li><a href="PReport.jsp" class="style42">Product Report</a></li>
                </ul>
                    <ul class="style28">
                      <li><a href="CReport.jsp" class="style42">Customer Report</a></li>
                    </ul>
                  <ul class="style28">
                      <li><a href="PReport.jsp" class="style42">Retailer Report</a></li>
                  </ul>
                  <ul class="style28">
                      <li><a href="DReport.jsp" class="style42">Distributor Report</a></li>
                  </ul>
                  <ul class="style28">
                      <li><a href="MReport.jsp" class="style42">Manufacture Report </a></li>
                  </ul></td>
              </tr>
            </table></td>
          </tr>
	...
	<tr>
    	...
    	<td background="../images/KINGW014.JPG"width="608" height="38">&nbsp;</td>
	  	<td background="../images/KINGW014.JPG"width="217" height="38"><div align="center"><a href="../Man.jsp" class="style28 style30">HOME</a></div></td>
  	</tr>
</table>
