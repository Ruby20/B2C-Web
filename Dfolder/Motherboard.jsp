...
.style70 {color: #0033FF; font-weight: bold; }
-->
</style>
</head>
  ...
  <div id="div" align="">
    <form id="order" action="Update.jsp" method="post" onsubmit="return isEmpty()">
      <table width="100%" border="1" align="center" background="../images/back.jpg">
        <tr>
          <td colspan="8"><div align="center" class="style64 style65">Motherboards</div></td>
        </tr>
        <tr>
          <td width="20%"><div align="center">Model</div></td>
          <td width="20%"><div align="center">Market Price</div></td>
          <td width="20%"><div align="center">Socket</div></td>
          <td width="20%"><div align="center">Speed</div></td>
          <td width="20%"><div align="center">L2Cache </div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        <td><div align="center" class="style67"><a href="../DOrders.jsp" class="style70">Buy Now</a></div></td>
          <td><div align="center"><a href="Products.jsp" class="style69 style67">Back</a></div></td>
        </tr>
      </table>
