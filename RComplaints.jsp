...
.style59 {color: green}
.style60 {color: #FF6600; font-size: 18px; }
-->
</style>
</head>
...
<div id="logo">
	<h1><span class="style57">B</span> <span class="style59">2</span> <span class="style57">c network solutions</span> </h1>
</div>
...
<div id="menu">
 ...
 <table width="100%" border="0">
    <tr>
      <td width="24%"><span class="style57 style58">Welcome</span></td>
      <td width="41%"><span class="style51 style59 style58">
        <%if(usrname==null){}else{%>
        <%=usrname%>
        <%}%>
      </span></td>
      <td width="35%"><span class="style60">Retailers Blog</span></td>
    </tr>
  </table>
  <table width="100%" height="79" border="0">
    <tr>
      <td width="20%" height="75"><a href="Ret.jsp">home</a></td>
...
<table width="73%" height="782" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr >
	...
	<td background="images/top1bg.gif"><div align="center"><a href="Ret.jsp" class="style25">Home</a></div></td>
  ...
  <tr>
    ...
    <td><b><font color="#FF66CC" size="1" face="Arial">
      <input  name="t4" type="text" id="t4" value="" />&nbsp;&nbsp;<A  href="javascript:NewCal('t4','ddmmyyyy')"><IMG 
                              alt="Select Date" 
                              src="images/calendar.gif" 
                              border=0></A>  Date Format: dd/mm/yyyy
    </font></b></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
