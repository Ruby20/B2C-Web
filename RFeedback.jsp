...
.style58 {color: #FF6600; font-size: 18px; }
.style59 {color: green}
-->
</style>
</head>
...
<div id="menu">
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td width="35%"><span class="style58">Retailers Blog</span></td>
    </tr>
  </table>
...
<table width="73%" height="678" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="202">&nbsp;</td>
    <td>Feedback</td>
    <td><textarea name="t6" cols="50" rows="10" id="t6"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="30">&nbsp;</td>
