...
<div id="header">
<div id="logo">
	<h1><span class="style40">B</span> <span class="style41">2</span> <span class="style40">c network solutions</span> </h1>
</div>
<div id="menu">
  <p>&nbsp;</p>
...
<table width="980" height="241" border="0" background="images/KINGW013.JPG" >
  <tr>
    ...
    <td width="743" height="237" ><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="700" height="188">
...
<div id="page">
  ...
  <tr>
	...
	<div id="sidebar1" class="sidebar">
		<ul>
			<li>
				<h2 class="style15"><font color="#00FFFF">Customer's Cart </font></h2>
				<ul>
	...
	<div id="div2" class="sidebar">
      <ul>
        <li>
          ...
          <ul>
            <li><a href="Cfolder/Services.jsp">Services</a></li>
            <li><a href="Cfolder/Products.jsp">Products</a></li>
            <li><a href="Cfolder/Alerts.jsp">Alerts</a></li>
            <li><a href="Cfolder/Downloads.jsp">Downloads</a></li>
          </ul>
        </li>
      </ul>
    </div>
