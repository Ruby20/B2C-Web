...
<div id="logo">
	<h1><span class="style57">B</span> <span class="style27">2</span> <span class="style57">c network solutions </span></h1>
</div>
...
<div id="menu">
  ...
  <table width="100%" height="79" border="0">
    <tr>
      <td width="20%" height="75"><a href="Dis.jsp">home</a></td>
...
<table width="73%" height="678" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="202">&nbsp;</td>
    <td>Feedback</td>
    <td><textarea name="t6" cols="60" rows="10" id="t6"></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="30">&nbsp;</td>
