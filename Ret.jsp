...
<div id="header">
<div id="logo">
	<h1><span class="style57">B</span> <span class="style65">2</span> <span class="style59">c network solutions</span> </h1>
</div>
<div id="menu">
  <p>&nbsp;</p>
  ...
  <table width="100%" height="55" border="0">
    <tr>
      ...
      <td width="20%"><a href="Rfolder/abts.jsp" class="style24">About us</a></td>
      <td width="20%"><a href="Rfolder/cnts.jsp" class="style24">Contact</a></td>
      <td width="20%"><a href="Rfolder/stms.jsp" class="style24">Sitemap</a></td>
...
<table width="980" height="241" border="0" background="images/KINGW013.JPG" >
  <tr>
    ...
    <td width="743" height="237" ><div align="center">
      ...
      <p align="center" class="entry style5">Customers Oriented Approach &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/acc_handheld_accessories_70.gif" alt="Asseseries" /> &nbsp;<img src="images/acc_computer_accessories_70.gif" alt="asseseries" />&nbsp;<img src="images/acc_scanner_accessories_70.gif" alt="" width="70" height="70" /></p>
      </div></td>
		...
		<ul>
			<li>
				...
				<ul>
					...
					<li><a href="Rfolder/CReport.jsp">Customers Reports </a></li>
					<li><a href="Rfolder/RReport.jsp">Retailers Reports </a></li>
					<li><a href="Rfolder/DReport.jsp">Distributors Reports </a></li>
					<li><a href="Rfolder/MReport.jsp">Manufactureres Report </a></li>
				 <li><a href="RFeedback.jsp">Feedback</a></li>
				</ul>
			</li>
	    </ul>
	</div>
	<div id="div2" class="sidebar">
      <ul>
        <li>
          ...
          <ul>
		  <li><a href="RProfile.jsp">Your Profile</a></li>
            <li><a href="Rfolder/Services.jsp">Services</a></li>
            <li><a href="Rfolder/Products.jsp">Products</a></li>
            <li><a href="ROrders.jsp">Orders</a></li>
           
            
            <li><a href="RComplaints.jsp">Compliants</a></li>
