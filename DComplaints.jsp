...
<div id="logo">
	<h1><span class="style59">B</span> <span class="style27">2</span> <span class="style59">c network solutions</span> </h1>
</div>
...
<div id="menu">
  ...
  <table width="100%" height="77" border="0">
    <tr>
      <td width="20%" height="73"><a href="Dis.jsp">home</a></td>
...
<table width="73%" height="782" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr >
	...
	<td background="images/top1bg.gif"><div align="center"><a href="Dis.jsp" class="style25">Home</a></div></td>
